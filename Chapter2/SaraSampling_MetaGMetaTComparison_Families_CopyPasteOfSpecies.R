...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/ComparisonMetaGMetaT/FigMetaTMetaG_Families_FungalReads.pdf", plot=p1, device = cairo_pdf(), width=21, height=10)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/ComparisonMetaGMetaT/FigMetaTMetaG_Families_FungalReads.png", plot=p1, device = "png", dpi = 300, width=21, height=10)
dev.off()
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/ComparisonMetaGMetaT/FigMetaTMetaG_Families_ClassifiedReads.pdf", plot=p1, device = cairo_pdf(), width=21, height=10)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/ComparisonMetaGMetaT/FigMetaTMetaG_Families_ClassifiedReads.png", plot=p1, device = "png", dpi = 300, width=21, height=10)
dev.off()
...
write.csv(SortedSpecies_Conf_0.0, file = "/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/Tables/ComparisonMetaGMetaT/Species/RelativeAbundance/RelativeAbundanceFamilies_Conf_0.0.csv", row.names = FALSE)
...
write.csv(SortedSpecies_Conf_0.1, file = "/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/Tables/ComparisonMetaGMetaT/Species/RelativeAbundance/RelativeAbundanceFamilies_Conf_0.1.csv", row.names = FALSE)
...
write.csv(SortedSpecies_Conf_0.6, file = "/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/Tables/ComparisonMetaGMetaT/Species/RelativeAbundance/RelativeAbundanceFamilies_Conf_0.6.csv", row.names = FALSE)
...
write.csv(SortedSpecies_Conf_0.0_DiffRelAb, file = "/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/Tables/ComparisonMetaGMetaT/Species/DifferentialExpression/MostDifferentialyAbundantFamilies_Conf_0.0.csv", row.names = FALSE)
...
write.csv(SortedSpecies_Conf_0.1_DiffRelAb, file = "/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/Tables/ComparisonMetaGMetaT/Species/DifferentialExpression/MostDifferentialyAbundantFamilies_Conf_0.1.csv", row.names = FALSE)
...
write.csv(SortedSpecies_Conf_0.6_DiffRelAb, file = "/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/Tables/ComparisonMetaGMetaT/Species/DifferentialExpression/MostDifferentialyAbundantFamilies_Conf_0.6.csv", row.names = FALSE)
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/SupplementaryFigures/MetaT_MetaG_Families_RelAb0.0.pdf", plot=p1, device = cairo_pdf(), width=21, height=10)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/SupplementaryFigures/MetaT_MetaG_Families_RelAb0.0.png", plot=p1, device = "png", dpi = 300, width=21, height=10)
dev.off()
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/MainFigures/MetaT_MetaG_Families_RelAb0.1.pdf", plot=p1, device = cairo_pdf(), width=21, height=10)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/MainFigures/MetaT_MetaG_Families_RelAb0.1.png", plot=p1, device = "png", dpi = 300, width=21, height=10)
dev.off()
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/SupplementaryFigures/MetaT_MetaG_Families_RelAb0.6.pdf", plot=p1, device = cairo_pdf(), width=21, height=10)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/SupplementaryFigures/MetaT_MetaG_Families_RelAb0.6.png", plot=p1, device = "png", dpi = 300, width=21, height=10)
dev.off()
...
DF_ListSpecAboveThresh_AllConf_MetaG <- read.csv("/home/emilelaymand/Documents/Science/These/Sara_Sampling_2022/metaT/SpeciesAboveThreshold/ListSpecAboveThresh_AllConf_Families_MetaG.csv")
...
write.csv(DF_ListSpecAboveThresh_AllConf_MetaT_MetaG_Final_Sorted, "/home/emilelaymand/Documents/Science/These/Sara_Sampling_2022/metaT/SpeciesAboveThreshold/ListSpecAboveThresh_AllConf_Families_MetaT_MetaG.csv", row.names = FALSE)
...
write.csv(DF_ListSpecAboveThresh_AllConf_MetaT_MetaG_Final0106_Sorted_Nonempty, "/home/emilelaymand/Documents/Science/These/Sara_Sampling_2022/metaT/SpeciesAboveThreshold/ListSpecAboveThresh_AllConf_Families_MetaT_MetaG_0.1_0.6_only.csv", row.names = FALSE)
