#=============================================================================================================================#
# This script is a copy paste of SaraSampling_MetaGAnalysis_Species.R on 2024_07_05 but with species replaced by the families #
...
DF_PavianSpecies_Conf_0.0 <- read.table("/home/emilelaymand/Documents/Science/These/Sara_Sampling_2022/metaG/SortiesKraken2/Pavian_Confidence_0.0/Analysis/RawPavianReports/SaraSampling_MetaG_Kraken2_Confidence_0.0_Fungi_Family.tsv", sep = "\t", header = TRUE)
...
DF_PavianSpecies_Conf_0.1 <- read.table("/home/emilelaymand/Documents/Science/These/Sara_Sampling_2022/metaG/SortiesKraken2/Pavian_Confidence_0.1/Analysis/RawPavianReports/SaraSampling_MetaG_Kraken2_Confidence_0.1_Fungi_Family.tsv", sep = "\t", header = TRUE)
...
DF_PavianSpecies_Conf_0.6 <- read.table("/home/emilelaymand/Documents/Science/These/Sara_Sampling_2022/metaG/SortiesKraken2/Pavian_Confidence_0.6/Analysis/RawPavianReports/SaraSampling_MetaG_Kraken2_Confidence_0.6_Fungi_Family.tsv", sep = "\t", header = TRUE)
...
write.csv(SortedSpecies_Conf_0.0, file = "/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/Tables/MetaG/Species/RelativeAbundance/RelativeAbundanceFamilies_Conf_0.0.csv", row.names = FALSE)
...
write.csv(SortedSpecies_Conf_0.1, file = "/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/Tables/MetaG/Species/RelativeAbundance/RelativeAbundanceFamilies_Conf_0.1.csv", row.names = FALSE)
...
write.csv(SortedSpecies_Conf_0.6, file = "/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/Tables/MetaG/Species/RelativeAbundance/RelativeAbundanceFamilies_Conf_0.6.csv", row.names = FALSE)
...
ShannonConf0.0_DF_F <- ShannonConf0.0_DF_F[!(row.names(ShannonConf0.0_DF_F) %in% c("G_CCO01.1_G1", "G_FCT10.1_G1", "G_FGR08.1_G1", "G_FGR09.1_G1", "G_FMS04.1_G1", "G_FSS01.1_G1")),] # G_FSS01.1_G1 added on 2024-07-08
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/AlphaDiversity/Species/FigAlphaDivFranceFamilies_Shannon_Conf_0.0.pdf", plot=p1, device = cairo_pdf(), width=21, height=20)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/AlphaDiversity/Species/FigAlphaDivFranceFamilies_Shannon_Conf_0.0.png", plot=p1, device = "png", dpi = 300, width=21, height=20)
dev.off()
...
SimpsonConf0.0_DF <- SimpsonConf0.0_DF[!(row.names(SimpsonConf0.0_DF) %in% c("G_CCO01.1_G1", "G_FCT10.1_G1", "G_FGR08.1_G1", "G_FGR09.1_G1", "G_FMS04.1_G1", "G_FSS01.1_G1")),] # G_FSS01.1_G1 added on 2024-07-08
# c("AGTU-31", "AGTU-61", "AGTU-12", "AGTU-6", "AGTU-59")
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/AlphaDiversity/Species/FigAlphaDivFranceFamilies_Simpson_Conf_0.0.pdf", plot=p1, device = cairo_pdf(), width=21, height=20)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/AlphaDiversity/Species/FigAlphaDivFranceFamilies_Simpson_Conf_0.0.png", plot=p1, device = "png", dpi = 300, width=21, height=20)
dev.off()
...
ShannonConf0.1_DF_F <- ShannonConf0.1_DF_F[!(row.names(ShannonConf0.1_DF_F) %in% c("G_CCO01.1_G1", "G_FCT10.1_G1", "G_FGR08.1_G1", "G_FGR09.1_G1", "G_FMS04.1_G1", "G_FSS01.1_G1")),] # 2024-07-08
# c("AGTU-31", "AGTU-61", "AGTU-12", "AGTU-6", "AGTU-59")
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/AlphaDiversity/Species/FigAlphaDivFranceFamilies_Shannon_Conf_0.1.pdf", plot=p1, device = cairo_pdf(), width=21, height=20)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/AlphaDiversity/Species/FigAlphaDivFranceFamilies_Shannon_Conf_0.1.png", plot=p1, device = "png", dpi = 300, width=21, height=20)

ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/MainFigures/FigAlphaDivFranceFamilies_Shannon_Conf_0.1.pdf", plot=p1, device = cairo_pdf(), width=21, height=20)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/MainFigures/FigAlphaDivFranceFamilies_Shannon_Conf_0.1.png", plot=p1, device = "png", dpi = 300, width=21, height=20)
dev.off()
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/AlphaDiversity/Species/FigAlphaDivFranceFamilies_Simpson_Conf_0.1.pdf", plot=p1, device = cairo_pdf(), width=21, height=20)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/AlphaDiversity/Species/FigAlphaDivFranceFamilies_Simpson_Conf_0.1.png", plot=p1, device = "png", dpi = 300, width=21, height=20)

ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/MainFigures/FigAlphaDivFranceFamilies_Simpson_Conf_0.1.pdf", plot=p1, device = cairo_pdf(), width=21, height=20)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/MainFigures/FigAlphaDivFranceFamilies_Simpson_Conf_0.1.png", plot=p1, device = "png", dpi = 300, width=21, height=20)
dev.off()
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/AlphaDiversity/Species/FigAlphaDivFranceFamilies_Shannon_Conf_0.6.pdf", plot=p1, device = cairo_pdf(), width=21, height=20)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/AlphaDiversity/Species/FigAlphaDivFranceFamilies_Shannon_Conf_0.6.png", plot=p1, device = "png", dpi = 300, width=21, height=20)
dev.off()
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/AlphaDiversity/Species/FigAlphaDivFranceFamilies_Simpson_Conf_0.6.pdf", plot=p1, device = cairo_pdf(), width=21, height=20)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/AlphaDiversity/Species/FigAlphaDivFranceFamilies_Simpson_Conf_0.6.png", plot=p1, device = "png", dpi = 300, width=21, height=20)
dev.off()
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/MainFigures/NMDS_ColorSite_0.1_Family.pdf", plot=p1, device = cairo_pdf(), width=10, height=10)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/MainFigures/NMDS_ColorSite_0.1_Family.png", plot=p1, device = "png", dpi = 300, width=10, height=10)
dev.off()
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/MainFigures/NMDS_ColorSite_0.1_NormAssignedFungalFamilies.pdf", plot=p1, device = cairo_pdf(), width=10, height=10)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/MainFigures/NMDS_ColorSite_0.1_NormAssignedFungalFamilies.png", plot=p1, device = "png", dpi = 300, width=10, height=10)
dev.off()
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/MostAbundantTaxa/Species/FigMostAbTaxaAmongstAllReads_Families_Conf_0.0.pdf", plot=p1, device = cairo_pdf(), width=49, height=49)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/MostAbundantTaxa/Species/FigMostAbTaxaAmongstAllReads_Families_Conf_0.0.png", plot=p1, device = "png", dpi = 300, width=49, height=49)
dev.off()
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/MostAbundantTaxa/Species/FigMostAbTaxaAmongstAllReads_Families_SummedAllSamples_Conf_0.0.pdf", plot=p1, device = cairo_pdf(), width=49, height=49)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/MostAbundantTaxa/Species/FigMostAbTaxaAmongstAllReads_Families_SummedAllSamples_Conf_0.0.png", plot=p1, device = "png", dpi = 300, width=49, height=49)
dev.off()
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/SupplementaryFigures/Fig10MostAbTaxaPerSite_Families_Conf_0.0.pdf", plot=p1, device = cairo_pdf(), width=21, height=10)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/SupplementaryFigures/Fig10MostAbTaxaPerSite_Families_Conf_0.0.png", plot=p1, device = "png", dpi = 300, width=21, height=10)
dev.off()
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/MostAbundantTaxa/Species/FigMostAbTaxaAmongstAllReads_Families_Conf_0.1.pdf", plot=p1, device = cairo_pdf(), width=49, height=49)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/MostAbundantTaxa/Species/FigMostAbTaxaAmongstAllReads_Families_Conf_0.1.png", plot=p1, device = "png", dpi = 300, width=49, height=49)
dev.off()
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/MostAbundantTaxa/Species/FigMostAbTaxaAmongstAllReads_Families_SummedAllSamples_Conf_0.1.pdf", plot=p1, device = cairo_pdf(), width=49, height=49)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/MostAbundantTaxa/Species/FigMostAbTaxaAmongstAllReads_Families_SummedAllSamples_Conf_0.1.png", plot=p1, device = "png", dpi = 300, width=49, height=49)
dev.off()
...
p1 <- ggplot(data = DF_RelAbMostAbSpecForPlot_t_longer, aes(x = Species, y = RelAbundance, fill = Site)) +
  ...
  #scale_fill_manual(values = c("deepskyblue", "gold", "gold2", "darkolivegreen1", "darkolivegreen3", "darkolivegreen4", "forestgreen")) +
  scale_fill_manual(values = c("darkorchid2", "gold", "goldenrod4", "deepskyblue", "dodgerblue4", "darkolivegreen1", "forestgreen")) +
  labs(x = "Families", y = "Mean relative abundance (% of all reads)") +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.3))

plot(p1)

ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/MainFigures/Fig10MostAbTaxaPerSite_Families_Conf_0.1.pdf", plot=p1, device = cairo_pdf(), width=21, height=10)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/MainFigures/Fig10MostAbTaxaPerSite_Families_Conf_0.1.png", plot=p1, device = "png", dpi = 300, width=21, height=10)
dev.off()
...
pheatmap(DF_ForHeatmap_0.1_t_GoodCol_GoodSite_Num_NormRow, cutree_rows = 10, cluster_cols = TRUE, color = paletteer_c("grDevices::Purples 3", 30, direction = -1))
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/MostAbundantTaxa/Species/FigMostAbTaxaAmongstAllReads_Families_Conf_0.6.pdf", plot=p1, device = cairo_pdf(), width=49, height=49)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/MostAbundantTaxa/Species/FigMostAbTaxaAmongstAllReads_Families_Conf_0.6.png", plot=p1, device = "png", dpi = 300, width=49, height=49)
dev.off()
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/MostAbundantTaxa/Species/FigMostAbTaxaAmongstAllReads_Families_SummedAllSamples_Conf_0.6.pdf", plot=p1, device = cairo_pdf(), width=49, height=49)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/RawFigures/MostAbundantTaxa/Species/FigMostAbTaxaAmongstAllReads_Families_SummedAllSamples_Conf_0.6.png", plot=p1, device = "png", dpi = 300, width=49, height=49)
dev.off()
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/SupplementaryFigures/Fig10MostAbTaxaPerSite_Families_Conf_0.6.pdf", plot=p1, device = cairo_pdf(), width=21, height=10)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/SupplementaryFigures/Fig10MostAbTaxaPerSite_Families_Conf_0.6.png", plot=p1, device = "png", dpi = 300, width=21, height=10)
dev.off()
...
p1 <- ggplot(DF_ListCumSums_0.1_Long_GoodCol_summary, aes(x=Rank, y = Median, group = Site)) +
  geom_line(aes(color = Site)) +
  geom_point(aes(color = Site)) +
  geom_line(aes(x=Rank, y=FirstQuartile, color = Site), linetype = "dashed") +
...
# ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/MainFigures/PCA_Figure3_FinalPCA.pdf", plot=PCA_Figure3_CytoFlux_PercFungi, device = cairo_pdf(), width=15, height=10)
# dev.off()
...
write.csv(DF_ListSpecAboveThresh_AllConf, "/home/emilelaymand/Documents/Science/These/Sara_Sampling_2022/metaT/SpeciesAboveThreshold/ListSpecAboveThresh_AllConf_Families_MetaG.csv", row.names = FALSE)
...
#==================================================================================#
# Calculate the relative abundance of the families that were abundant in chapter 1 #
#==================================================================================#

# List of families for which we must check the relative abundance (the families of the 41 most abundant ASVs)
# Note that many ASVs were reliably assigned only at the order level

SpecieFromChap1 <- c("Cordycipitaceae", "Debaryomycetaceae", "Helotiales", "Malasseziaceae", "Rhizophydiales", "Rhizophydiales", "Dothideomycetidae", "Dothideomycetidae", "Cladosporiaceae/Davidiellaceae", "Cladosporiaceae", "Davidiellaceae", "Sympoventuriaceae", "Saccharomycetaceae", "Pleosporaceae", "Debaryomycetaceae", "Herpotrichiellaceae", "Pleosporaceae", "Aspergillaceae", "Dothideomycetes", "Malasseziaceae", "Aspergillaceae+Thermoascaceae", "Aspergillaceae+Thermoascaceae clade", "Aspergillaceae", "Thermoascaceae", "Saccharomycetaceae", "Hypocreales", "Aigialaceae", "Pleosporales", "Rhynchogastremaceae", "Chaetothyriales", "Debaryomycetaceae")

SpecieFromChap1_FamOnly <- c("Cordycipitaceae", "Debaryomycetaceae", "Malasseziaceae", "Cladosporiaceae/Davidiellaceae", "Cladosporiaceae", "Davidiellaceae", "Sympoventuriaceae", "Saccharomycetaceae", "Pleosporaceae", "Debaryomycetaceae", "Herpotrichiellaceae", "Pleosporaceae", "Aspergillaceae", "Malasseziaceae", "Aspergillaceae+Thermoascaceae", "Aspergillaceae+Thermoascaceae clade", "Aspergillaceae", "Thermoascaceae", "Saccharomycetaceae", "Aigialaceae", "Rhynchogastremaceae", "Debaryomycetaceae")

SpecieFromChap1_FamOnly_uniq <- unique(SpecieFromChap1_FamOnly)

# 0.1

DF_PavianSpecies_Conf_0.1_Norm_Chap1 <- DF_PavianSpecies_Conf_0.1_Norm_Thresh
DF_PavianSpecies_Conf_0.1_Norm_Chap1_t <- as.data.frame(t(DF_PavianSpecies_Conf_0.1_Norm_Chap1))
DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced <- DF_PavianSpecies_Conf_0.1_Norm_Chap1_t %>% replace(is.na(.), 0)
Max_AllSpec_0.1_Families <- sapply(DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced, max)
Max_AllSpec_0.1_Families_SpecChap1 <- sort(Max_AllSpec_0.1_Families[which(names(Max_AllSpec_0.1_Families) %in% SpecieFromChap1_FamOnly_uniq)], decreasing = TRUE)

# Make a barplot similar to the majoritarian families, but with these species
...
# List all the names of the species that appear within the 10 most abundant species in at least 1 site
ListNmostAbAllSites <- names(Max_AllSpec_0.1_Families_SpecChap1)
...
# Convert 0 to NA so that they are not plotted with log scale

DF_RelAbMostAbSpecForPlot_t_longer_NAto0 <- DF_RelAbMostAbSpecForPlot_t_longer
DF_RelAbMostAbSpecForPlot_t_longer_NAto0$RelAbundance[DF_RelAbMostAbSpecForPlot_t_longer_NAto0$RelAbundance == 0] <- NA # Check

# Make the plot

# Barplot
p1 <- ggplot(data = DF_RelAbMostAbSpecForPlot_t_longer_NAto0, aes(x = Species, y = RelAbundance, fill = Site)) +
  geom_bar(position='dodge', stat='identity') +
  #scale_fill_manual(values = c("deepskyblue", "gold", "gold2", "darkolivegreen1", "darkolivegreen3", "darkolivegreen4", "forestgreen")) +
  scale_fill_manual(values = c("darkorchid2", "gold", "goldenrod4", "deepskyblue", "dodgerblue4", "darkolivegreen1", "forestgreen")) +
  scale_y_continuous(trans='log10', limits = c(0.000000001, 0.001)) +
  labs(x = "Families", y = "Mean relative abundance (% of all reads)") +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.3))
...
# Points
p1 <- ggplot(data = DF_RelAbMostAbSpecForPlot_t_longer_NAto0, aes(x = Species, y = RelAbundance, color = Site)) +
...
DF_RelAbMostAbSpecForPlot_t_longer %>%
  group_by(Species) %>%
  summarise(max = max(RelAbundance, na.rm=TRUE))

# So there is an error somewhere because the max is an order of magnitude higher here for Cordycipitaceae --> Actually, no error if I am correct

#-------------------------------------------------------------------------------#
# Make a boxplot wth the 10 families to which the 41 ASVs from chapter 1 belong #
#-------------------------------------------------------------------------------#

SpecieFromChap1_FamOnly_BoxPlot <- c("Cordycipitaceae", "Debaryomycetaceae", "Malasseziaceae", "Sympoventuriaceae", "Saccharomycetaceae", "Pleosporaceae", "Debaryomycetaceae", "Herpotrichiellaceae", "Pleosporaceae", "Aspergillaceae", "Malasseziaceae", "Saccharomycetaceae", "Aigialaceae", "Rhynchogastremaceae", "Debaryomycetaceae")

SpecieFromChap1_FamOnly_BoxPlot_uniq <- unique(SpecieFromChap1_FamOnly_BoxPlot)

DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot <- DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced[,SpecieFromChap1_FamOnly_BoxPlot_uniq]
DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot$Site <- substr(row.names(DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot), 3, 5)

# Pivot longer

DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot_Long <- DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot %>%
  pivot_longer(
    cols = !Site,
    names_to = "Species",
    values_to = "RelAbundance",
...
p1 <- ggplot(data = DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot_Long, aes(x=Species, y=RelAbundance, color = Site)) +
  #stat_boxplot(geom ='errorbar', width = 0.5) +
  geom_boxplot(outlier.colour = "black", outlier.shape = 1) +
...
# Convert all 0 to 10e-9 # Edit 2024/10/02: for consistency with the other plots of the chapter, I changed to 10e-10

DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot_Long_Rep <- DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot_Long
DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot_Long_Rep$RelAbundance[DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot_Long_Rep$RelAbundance == 0] <- 0.0000000001 # Check

# Sort sites 

DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot_Long_Rep$Site <- factor(DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot_Long_Rep$Site, levels = c("FMS", "FSS", "FHB", "FLC", "FGR", "FLP", "FCT"))

# Sort species

NamesFactor_BoxplotChap1 <- names(sort(colSums(DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot[,!(colnames(DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot) %in% c("Site"))]), decreasing = TRUE))

DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot_Long_Rep$Species <- factor(DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot_Long_Rep$Species, levels = NamesFactor_BoxplotChap1)

p1 <- ggplot(data = DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot_Long_Rep, aes(x=Species, y=RelAbundance, color = Site)) +
  #stat_boxplot(geom ='errorbar', width = 0.5) +
  geom_boxplot(outlier.colour = "black", outlier.shape = 1) +
  ylab(label = "Relative abundance") +
  scale_y_continuous(trans='log10') +
  #ylim(c(0, 3.5)) +
  #scale_fill_manual(values = c("chocolate1", "darkolivegreen3", "gold", "deepskyblue")) +
  #scale_color_manual(values = c("deepskyblue", "gold", "goldenrod4", "darkolivegreen1", "darkolivegreen3", "darkolivegreen4", "springgreen4")) +
  #scale_color_manual(values = c("deepskyblue", "gold", "goldenrod4", "lightgreen", "green", "darkolivegreen3", "springgreen4")) +
  scale_color_manual(values = c("darkorchid2", "gold", "goldenrod4", "deepskyblue", "dodgerblue4", "darkolivegreen1", "forestgreen")) +
...
p1 <- ggplot(data = DF_PavianSpecies_Conf_0.1_Norm_Chap1_t_NaReplaced_Boxplot_Long_Rep, aes(x=Species, y=RelAbundance, color = Site)) +
  #stat_boxplot(geom ='errorbar', width = 0.5) +
  geom_boxplot(outlier.colour = "black", outlier.shape = 1, outlier.size = 3) +
  ylab(label = "Relative abundance") +
  xlab(label = "Families") +
  scale_y_continuous(trans='log10') +
  ...
  #scale_color_manual(values = c("deepskyblue", "gold", "goldenrod4", "lightgreen", "green", "darkolivegreen3", "springgreen4")) +
  scale_color_manual(values = c("darkorchid2", "gold", "goldenrod4", "deepskyblue", "dodgerblue4", "darkolivegreen1", "forestgreen")) +
  #scale_color_manual(values = c("deepskyblue", "gold", "goldenrod4", "darkolivegreen1", "darkolivegreen3", "darkolivegreen4", "forestgreen")) +
  geom_hline(yintercept = 0.000000001, color = "black", linetype = "dashed") +
  theme_bw() +
  theme(
    axis.text = element_text(size = 20),
...
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/SupplementaryFigures/Fig10FamiliesFromChap1_0.1.pdf", plot=p1, device = cairo_pdf(), width=15, height=10)
ggsave(file="/home/emilelaymand/Documents/Science/These/Manuscrit/PartiesManuscrit/Chapitre2/SupplementaryFigures/Fig10FamiliesFromChap1_0.1.png", plot=p1, device = "png", dpi = 300, width=15, height=10)
dev.off()
